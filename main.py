...
def apply_triangles(palette, energy):
    for i in range(round(int(energy) * int(complexity) / 5)):  # Energy sets how many times the applicator runs i.e. how many different types of triangle it draws
...
def apply_quads(palette, energy):
    for i in range(round(int(energy) * int(complexity) / 5)):
